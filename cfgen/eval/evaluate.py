...
def compute_umap_and_wasserstein(X_generated_dict, 
                                 X_real, 
                                 plotting_folder, 
                                 epoch,
                                 modality_list
    ...
    for mod in modality_list:
        ...
        X_generated = np.asarray(X_generated_dict[mod])
        X_real[mod] = np.asarray(X_real[mod])
        ...
        X = np.concatenate([X_generated, X_real[mod]], axis=0)
